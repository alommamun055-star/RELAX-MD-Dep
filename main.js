...
global.channelLink = "https://whatsapp.com/channel/0029VbCTMVr4tRrrogSVaD0A";
global.ytch = "⤹𝐗 𝐑𝐎𝐌𝐄𝐎𓂃༊";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbCTMVr4tRrrogSVaD0A'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/KzWrYXOqX62FmG2qkwuGJf`
                }, { quoted: message });
                return;
            }
        }
